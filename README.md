...
A full-stack web application that takes a Job Description and your Current Resume, uses Claude AI to rewrite it as an ATS-optimized resume, converts it to LaTeX, and compiles it into a beautiful PDF via Overleaf — all in under a minute.
...
| AI Model | Anthropic Claude (`claude-sonnet-4-5-20250929`) |
...
2. **Claude** rewrites your resume with ATS-optimized keywords and structure
3. **Claude** converts the optimized resume into LaTeX using a professional template
